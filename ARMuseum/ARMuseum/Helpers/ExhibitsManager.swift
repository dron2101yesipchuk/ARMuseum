...
class ExhibitsManager {
    ...
    private var exhibits: [String:VirtualInfo] = [
        ...
        "chandelier":VirtualInfo(name: "Candelabrum made of pistons", text: "Канделя́бр (фр. candélabre від лат. candela — «свічка») — декоративна підставка (свічник) з розгалуженнями для тримання свічки або декількох свічок чи ламп[1]. Виготовлялися з металу, кераміки, дерева і, навіть кришталю. З приходом електрики, свічки і свічники поступово витіснені чистішим, яскравішим та безпечнішим електролампам. Сучасні свічники, найчастіше виготовлені з металу, і досі використовуються у тих областях, у яких немає електрики та в більшості культових місць, де призначення свічників з часом не змінилося. Деякі люстри для свічок тепер переробляються під електричні лампи. Ці перетворення здійснюються, насамперед, з естетичних причин, щоби поєднати гарні антикварні речі з сучасними технологіями.", images: [], audio: nil, videoLink: nil),
        "adam":VirtualInfo(name: "Створення Адама", text: "Створення Адама.\n\nСтелю Сікстинської капели, розписаної Мікеланджело між 1508 і 1512 роками, є одним з найвідоміших творів Високого Відродження. «Створення Адама» є однією з найвідоміших картин усіх часів. Також ця робота була предметом незліченних посилань і пародій.", images: [UIImage(named: "adam_part")], audio: nil, videoLink: nil)
    ]
